...
const Map = () => {
  ...
  const svgIcon = divIcon({
    ...
    <svg class="svg-icon" viewBox="0 0 20 20">
              <path fill="white" d="M8.652,16.404c-0.186,0-0.337,0.151-0.337,0.337v2.022c0,0.186,0.151,0.337,0.337,0.337s0.337-0.151,0.337-0.337v-2.022C8.989,16.555,8.838,16.404,8.652,16.404z"></path>
              <path fill="white" d="M11.348,16.404c-0.186,0-0.337,0.151-0.337,0.337v2.022c0,0.186,0.151,0.337,0.337,0.337s0.337-0.151,0.337-0.337v-2.022C11.685,16.555,11.535,16.404,11.348,16.404z"></path>
              ...
              <path fill="white" d="M10,16.067c-0.186,0-0.337,0.151-0.337,0.337V19.1c0,0.186,0.151,0.337,0.337,0.337s0.337-0.151,0.337-0.337v-2.696C10.337,16.218,10.186,16.067,10,16.067z"></path>
            </svg>
    `,
    className: "",
    iconSize: [40, 40],
  ...
  return (
    <MapContainer center={[40.8054, -74.0241]} zoom={14} scrollWheelZoom={true} style={{ height: "100%", width: "100%" }} className="rounded-full border-8 border-slate-300">
      <TileLayer
